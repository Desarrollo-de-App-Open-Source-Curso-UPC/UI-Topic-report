...
2. **Creemos que** al diseñar una plataforma intuitiva y fácil de usar, facilitaremos la adopción del sistema por parte de dueños o administradores de restaurantes y su personal.**Sabremos que** hemos tenido éxito **cuando** la mayoría de los usuarios completen la configuración inicial sin asistencia y registren un uso recurrente del sistema.
