...
|---------------|--------------------------------------------------|---------|--------------------------------------------------|-----------------------------------------------------------------------------------------------------------------|---------------------|--------------|--------|
| US-16         | Gestión de ventas                                | T001    | Formulario de Registro de Venta                 | Diseñar la interfaz de formulario para registrar una venta (campos: ítems, cantidad, método de pago).         | 0.5h                |   Julio Castro    | Done   |
|               |                                                  | T002    | Confirmación de Venta Registrada               | Mostrar confirmación de registro y resumen de venta registrada.                                                 | 1h                  |      Julio Castro        | Done   |
| US-18         | Visualización de calificaciones recibidas        | T001    | Calificaciones por Orden                        | Crear el layout general que contenga las calificaciones por orden completada.                                  | 0.5h                |       Yaku Guzmán       | Done   |
|               |                                                  | T002    | Componente de Valoración                        | Crear componente para mostrar calificación y comentario.                                                        | 1h                  |       Yaku Guzmán       | Done   |
|               |                                                  | T003    | Manejo de Errores y Vacíos                      | Validar estados vacíos o errores (sin calificaciones, error de conexión, etc.).                                 | 0.5h                |       Gabriela Shapiama       | Done   |
|               |                                                  | T004    | Documentación: Vista de Calificaciones          | Documentar la vista de calificaciones, describiendo cómo se usa, qué datos muestra y cómo se integra.          | 0.5h                |       Julio Castro       | Done   |
| US-11         | Gestión de perfil                                | T001    | Editar mi Información                           | Crear formulario editable con campos de su información.                                                         | 0.5h                |      Jahaziel Guerra       | Done   |
|               |                                                  | T002    | Vinculación de Formulario con Datos Simulados   | Vincular formulario con datos simulados del perfil.                                                             | 1h                  |      Jahaziel Guerra        | Done   |
|               |                                                  | T003    | Validaciones Básicas                            | Implementar validaciones básicas.                                                                               | 0.5h                |       Julio Castro       | Done   |
|               |                                                  | T004    | Mensaje de Confirmación de Envío de Formulario  | Mostrar mensaje de confirmación tras guardar los cambios.                                                       | 0.5h                |       Yaku Guzmán       | Done   |
|               |                                                  | T005    | Diseño Responsivo y Accesible                   | Asegurar que el diseño sea responsivo y accesible.                                                              | 0.5h                |       Yaku Guzmán       | Done   |
| US-04         | Gestión manual de stock e insumos                | T001    | Formulario de Registro de Insumos              | Diseñar formulario para registrar insumos manualmente.                                                          | 0.5h                |     Yaku Guzmán         | Done   |
|               |                                                  | T002    | Visualización del Stock Actual                 | Implementar vista con tabla dinámica que muestre el stock actual de insumos registrados.                        | 1h                  |      Julio Castro        | Done   |
|               |                                                  | T003    | Edición de Insumos                              | Permitir al usuario editar insumos existentes desde la vista de stock.                                          | 1h                  |      Gabriela Shapiama        | Done   |
| US-12         | Visualizar ingredientes más usados               | T001    | Maquetar vista del panel de control             | Maquetar vista con opción de seleccionar el período de análisis.                                                | 2h                  |      Yaku Guzmán        | Done   |
|               |                                                  | T002    | Simular datos de uso de ingredientes            | Simular datos con frecuencia de uso para los períodos seleccionados.                                            | 0.5h                |       Jahaziel Guerra       | Done   |
|               |                                                  | T003    | Mostrar ingredientes más usados por período     | Mostrar lista o gráfico con ingredientes más usados en el período.                                              | 2h                  |       Yaku Guzmán       | Done   |
|               |                                                  | T004    | Funcionalidad para cambiar período              | Implementar funcionalidad para cambiar período de análisis.                                                     | 0.5h                |       Gabriela Shapiama       | Done   |
|               |                                                  | T005    | Actualizar datos según período seleccionado     | Actualizar datos mostrados según el nuevo período de análisis.                                                 | 0.5h                |      Williams Avendaño        | Done   |
|               |                                                  | T006    | Cambio de período sin recarga de página         | Asegurar cambio de período dinámico sin recarga.                                                                | 1h                  |       Jahaziel Guerra       | Done   |
|               |                                                  | T007    | Mejorar visualización de datos                  | Visualmente atractivos y fáciles de interpretar.                                                                | 0.5h                |      Jahaziel Guerra        | Done   |
|               |                                                  | T008    | Hacer vista responsiva y accesible              | Asegurar vista adaptativa para móviles y escritorio.                                                            | 1h                  |       Jahaziel Guerra       | Done   |
|               |                                                  | T009    | Probar flujo completo con datos mock            | Probar flujo completo de visualización con datos falsos.                                                        | 1h                  |        Yaku Guzmán      | Done   |
| US-13         | Ver alertas recientes                            | T001    | Maquetar vista de alertas recientes            | Vista de alertas por vencer, bajo stock, etc.                                                                   | 2h                  |      Gabriela Shapiama        | Done   |
|               |                                                  | T002    | Simular alertas con datos mock                  | Usar mock JSON con tipo de alerta, producto, cantidad, vencimiento.                                             | 0.5h                |       Gabriela Shapiama       | Done   |
|               |                                                  | T003    | Mostrar alertas clasificadas por tipo           | Clasificación por tipo con visualización clara.                                                                 | 2h                  |       Williams Avendaño       | Done   |
|               |                                                  | T004    | Marcar alertas como revisadas                  | Opción para que el admin marque alertas como revisadas.                                                         | 1h                  |       Yaku Guzmán       | Done   |
|               |                                                  | T005    | Mover alertas revisadas a sección archivadas    | Las revisadas se deben ocultar y pasar a "archivadas".                                                          | 0.5h                |      Williams Avendaño        | Done   |
|               |                                                  | T006    | Actualizar alertas dinámicamente                | Al marcar como revisada, debe actualizarse dinámicamente.                                                       | 1h                  |      Gabriela Shapiama         | Done   |
|               |                                                  | T007    | Notificar al archivar una alerta                | Mostrar confirmación al archivarse una alerta.                                                                  | 1h                  |      Jahaziel Guerra        | Done   |
|               |                                                  | T008    | Responsividad de vista de alertas               | Vista adaptativa para móviles y escritorio.                                                                     | 2h                  |      Jahaziel Guerra        | Done   |
| US-05         | Gestión integral de notificaciones               | T001    | Simular alertas con datos                       | Generar JSON con datos falsos: alerta, producto, cantidad, fecha.                                               | 0.5h                |       Williams Avendaño       | Done   |
|               |                                                  | T002    | Marcar alertas como revisadas                   | Admin puede marcar alertas como gestionadas.                                                                    | 2h                  |       Yaku Guzmán       | Done   |
|               |                                                  | T003    | Responsividad de vista de alertas               | Adaptativa para móviles y escritorio.                                                                           | 2h                  |       Gabriela Shapiama        | Done   |
|               |                                                  | T004    | Priorizar alertas críticas                      | Ordenar dando prioridad a alertas urgentes.                                                                     | 0.5h                |      Yaku Guzmán        | Done   |
| US-06         | Enviar comentarios y calificaciones              | T001    | Maquetar formulario de retroalimentación        | Vista con campos para calificación (estrellas) y comentario.                                                   | 2h                  |      Gabriela Shapiama        | Done   |
|               |                                                  | T002    | Validar entrega antes de permitir feedback      | Permitir comentarios solo si el pedido fue entregado.                                                           | 0.5h                |      Williams Avendaño        | Done   |
|               |                                                  | T003    | Validar datos del formulario                    | Rango permitido y comentario no vacío.                                                                          | 1h                  |      Yaku Guzmán        | Done   |
|               |                                                  | T004    | Registrar feedback en el sistema                | Guardar calificación y comentario asociados a pedido/proveedor.                                                 | 2h                  |     Williams Avendaño         | Done   |
| US-07         | Gestionar productos en el inventario             | T001    | Mostrar listado de productos                    | Mostrar productos registrados por el proveedor logueado.                                                        | 0.5h                |        Gabriela Shapiama      | Done   |
|               |                                                  | T002    | Maquetar formulario de nuevo producto           | Nombre, descripción, categoría y precio unitario.                                                               | 0.5h                |       Gabriela Shapiama       | Done   |
|               |                                                  | T003    | Validar datos al registrar producto             | Validar campos obligatorios.                                                                                    | 0.5h                |        Gabriela Shapiama      | Done   |
|               |                                                  | T004    | Registrar nuevo producto en catálogo            | Guardar producto y asociarlo al proveedor.                                                                      | 2h                  |      Gabriela Shapiama        | Done   |
|               |                                                  | T005    | Mostrar mensaje de éxito o error                | Notificación visual según resultado.                                                                            | 1h                  |     Jahaziel Guerra         | Done   |
|               |                                                  | T006    | Editar producto existente                       | Modificar nombre, descripción, categoría, precio.                                                               | 0.5h                |       Williams Avendaño       | Done   |
|               |                                                  | T007    | Guardar cambios al editar producto              | Validar cambios y actualizar producto.                                                                          | 1h                  |        Williams Avendaño      | Done   |
|               |                                                  | T008    | Eliminar producto                               | Eliminar producto con confirmación.                                                                            | 0.5h                |      Williams Avendaño        | Done   |
|               |                                                  | T009    | Manejar errores por datos inválidos             | Mensaje claro si hay errores al registrar o editar producto.                                                   | 1h                  |       Jahaziel Guerra       | Done   |
| US-14         | Identificar a los Mejores Clientes               | T001    | Sección “Mejores clientes”                      | Agregar sección en panel del proveedor.                                                                        | 0.5h                |       Gabriela Shapiama       | Done   |
|               |                                                  | T002    | Formulario con rango de fechas                  | Selección de fechas (PrimeVue, p-calendar).                                                                    | 1h                  |     Gabriela Shapiama         | Done   |
|               |                                                  | T003    | Realizar pruebas                                | Verificar que recuperación de contraseña funcione.                                                              | 1h                  |       Williams Avendaño       | Done   |
|               |                                                  | T004    | Validar selección de fechas completas           | Validar que ambas fechas estén completas.                                                                       | 1h                  |       Jahaziel Guerra       | Done   |
|               |                                                  | T005    | Definir interfaz DTO de respuesta               | nombreCliente, totalComprado, cantidadPedidos.                                                                  | 1h                  |      Jahaziel Guerra        | Done   |
|               |                                                  | T006    | Configurar servicio axios                       | Endpoint `/proveedores/{id}/mejores-clientes`.                                                                 | 0.5h                |        Jahaziel Guerra      | Done   |
|               |                                                  | T007    | Simular respuesta de mejores clientes (mock)    | Simular datos mientras no haya backend.                                                                         | 0.5h                |       Gabriela Shapiama       | Done   |
|               |                                                  | T008    | Renderizar tabla con p-datatable                | Ordenar por total comprado.                                                                                     | 0.5h                |       Julio Castro       | Done   |
|               |                                                  | T009    | Agregar feedback de carga y errores             | Mostrar carga (p-progressSpinner) y errores.                                                                    | 1h                  |       Julio Castro       | Done   |
|               |                                                  | T010    | Mostrar mensaje si no hay resultados            | Mensaje amigable si no hay resultados para el rango.                                                            | 1h                  |       Williams Avendaño       | Done   |
|               |                                                  | T011    | Función para exportar tabla (stub)              | Dejar función stub para exportar (Excel/PDF).                                                                   | 0.5h                |       Julio Castro       | Done   |
| US-08         | Gestión de Proveedores                           | T001    | Vista de proveedores disponibles                | Mostrar todos los proveedores registrados.                                                                      | 0.5h                |       Julio Castro       | Done   |
|               |                                                  | T002    | Buscar proveedor por nombre                     | Buscar por nombre parcial o completo.                                                                           | 1h                  |       Jahaziel Guerra       | Done   |
|               |                                                  | T003    | Filtrar proveedores por categoría               | Agregar filtro y aplicarlo al listado.                                                                          | 1h                  |      Williams Avendaño        | Done   |
|               |                                                  | T004    | Combinar filtros de nombre y categoría          | Aplicar búsqueda y filtro de forma combinada.                                                                   | 0.5h                |      Julio Castro        | Done   |
|               |                                                  | T005    | Agregar proveedor a lista personal              | Añadir proveedor a la lista del administrador.                                                                  | 0.5h                |      Jahaziel Guerra        | Done   |
|               |                                                  | T006    | Confirmar y guardar proveedor agregado          | Mostrar confirmación y guardar proveedor.                                                                       | 1h                  |       Julio Castro       | Done   |
|               |                                                  | T008    | Mostrar lista personal de proveedores           | Mostrar lista con nombre, contacto y estado.                                                                    | 0.5h                |       Jahaziel Guerra       | Done   |
|               |                                                  | T009    | Eliminar proveedor de lista                     | Permitir eliminación con confirmación.                                                                          | 1h                  |       Williams Avendaño       | Done   |
...
**Video:**
![Captura del video](assets/images/cap5/evidence-sprint4/evidenceexect.png)
[https://shorturl.at/ycRqr](https://shorturl.at/ycRqr)
...
![Captura del video](assets/images/cap5/evidence-sprint4/evidenceabout.png)

[https://shorturl.at/l9Udz](https://shorturl.at/l9Udz)

[https://youtu.be/INfI4xQTM28](https://youtu.be/INfI4xQTM28)
