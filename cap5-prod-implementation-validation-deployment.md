...
| **Sprint Goal & User Stories** |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| Sprint 2 Goal                        | Nuestro enfoque está en mejorar la experiencia de los nuevos visitantes a través <br />de una landing page más clara e integrada, y avanzar en la implementación de <br />módulos funcionales del sistema interno para usuarios autenticados, incluyendo <br />gestión de inventario, notificaciones, suscripciones y analíticas.<br />Creemos que esto proporciona una mejor comprensión del propósito de la solución <br />para los visitantes y habilita capacidades operativas esenciales para el personal de <br />los restaurantes.<br />Esto se confirmará cuando los visitantes puedan visualizar la nueva landing page <br />desde el acceso público, y los usuarios autenticados puedan navegar por el panel<br /> principal y acceder a los módulos mencionados desde la interfaz del sistema. |
