...
| **Sprint Goal & User Stories** |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| Sprint 2 Goal                        | Nuestro enfoque está en mejorar la experiencia de los nuevos visitantes a través de una landing page <br />más clara e integrada, y avanzar en la implementación de módulos funcionales del sistema interno para <br />usuarios autenticados, incluyendo gestión de inventario, notificaciones, suscripciones y analíticas. <br />Creemos que esto proporciona una mejor comprensión del propósito de la solución para los visitantes<br /> y habilita capacidades operativas esenciales para el personal de los restaurantes.<br />Esto se confirmará cuando los visitantes puedan visualizar la nueva landing page desde el acceso <br />público, y los usuarios autenticados puedan navegar por el panel principal y acceder a los módulos <br />mencionados desde la interfaz del sistema. |
